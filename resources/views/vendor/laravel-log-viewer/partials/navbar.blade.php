<nav class="navbar navbar-default fixed-top text-center h6"
     style="background-color:#2d3e50;color:white;font-size:12px;padding:0;margin:0;" role="navigation">
    <div class="container-fluid">
        <div class="row" style="height:auto;width:100%;">
            <div class="col-md-3"
                 style="display:flex;justify-content:center;align-items: center;flex-flow: column;padding:0;margin:0;">
