...
return [
    ...
    'free' => 'Free (Non-controlled) terms',
    'improve' => 'Modify your search. The following equation will be added at the end of the original equation',
    'impex' => "Ex: ('tw:(chicungunya) AND (instance:'regional'))".PHP_EOL."Will result in: (Created Equation) OR ('tw:(chicungunya) AND (instance:'regional'))",
